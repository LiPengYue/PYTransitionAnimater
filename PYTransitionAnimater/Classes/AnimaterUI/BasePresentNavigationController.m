...
- (void) presentAnimation: (void(^)(BasePresentNavigationController *weakSelf))block
       andCompletionBlock:(void(^)(BasePresentNavigationController *weakSelf))completion {
...
- (void) presentZoomAnimation: (UIView *)fromView
    ...
    [self presentAnimation:^(BasePresentNavigationController *weakSelf) {
...
- (void) dismissAnimation:(void(^)(BasePresentNavigationController *weakSelf))block
       andCompletionBlock:(void(^)(BasePresentNavigationController *weakSelf))completion {
...
- (void) dismissZoomAnimation: (UIView *)fromView andToView: (UIView *)toview {
    [self dismissAnimation:^(BasePresentNavigationController *weakSelf) {
